...
class SearchViewModel(
	...
	private val hintsList: MutableLiveData<List<CityModel>> =
		MutableLiveData<List<CityModel>>().default(arrayListOf())
	...
	fun getHintsList(): LiveData<List<CityModel>> = hintsList
